...
class ProjectManagerAddedNotification extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject("👋 Вас добавили руководителем проекта: {$this->project->name}")
            ->greeting("Здравствуйте, {$notifiable->name}!")
            ->line("Вас добавили в качестве руководителя проекта.")
