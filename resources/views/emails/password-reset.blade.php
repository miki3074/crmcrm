...
<div class="container">
    <div class="card">
        <div class="header">
            ...
            <h1>Восстановление <span class="gradient-text">пароля</span></h1>
        ...
        <div style="text-align: center;">
            <a href="{{ $resetUrl }}" class="button" style="color: white;">Сбросить пароль</a>
        </div>
        ...
        <div class="warning">
            ⚠️ <strong>Важно!</strong> Ссылка действительна в течение 60 минут. Если вы не запрашивали сброс пароля, просто проигнорируйте это письмо.
        </div>
