...
// Компоненты
import StatCard from './v2/Components/Dashboard/StatCard.vue'

import CompanySection from './v2/Components/Dashboard/CompanySection.vue'
import ProjectsSummary from './v2/Components/Dashboard/ProjectsSummary.vue'
import TasksSummary from './v2/Components/Dashboard/TasksSummary.vue'
import SubtasksSection from './v2/Components/Dashboard/SubtasksSection.vue'
import SearchOverlay from './v2/Components/Dashboard/SearchOverlay.vue'
import CreateCompanyModal from './v2/Components/Dashboard/CreateCompanyModal.vue'
import EmailVerificationModal from './v2/Components/Dashboard/EmailVerificationModal.vue'
